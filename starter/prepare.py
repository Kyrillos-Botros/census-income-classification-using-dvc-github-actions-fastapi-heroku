...
def go(args):
    ...
    raw_dataframe = raw_dataframe.applymap(
    ...
    idx = raw_dataframe["fnlgt"].between(
        args.min_fnlgt,
        args.max_fnlgt) & raw_dataframe["capital-loss"].between(
        args.min_capital_loss,
        args.max_capital_loss) & raw_dataframe["capital-gain"].between(
            args.min_capital_gain,
        args.max_capital_gain)
    ...
    os.system(
        f"cd {file_dir} && dvc commit {file_name} && dvc add {file_name} "
