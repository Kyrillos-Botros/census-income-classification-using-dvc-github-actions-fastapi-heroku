...
def go(config: DictConfig):
    ...
    os.system(
        f"dvc stage add -f -n prepare -d prepare.py -d ../data/census.csv "
    ...
    os.system(
        f"dvc stage add -f -n split "
        f"-d splitting_data.py "
        f"-d ../data/cleaned-data.csv "
    ...
    os.system(
        f"dvc stage add -f -n train "
        f"-d train_model.py "
        f"-d ../data/train-data.csv "
    ...
    os.system(
        f"dvc stage add -f -n evaluate "
        f"-d evaluate_model.py "
        f"-d ../data/test-data.csv "
        f"-d ../model/rfmodel.pkl "
